...
| <a id="opt-providers-file-directories" href="#opt-providers-file-directories" title="#opt-providers-file-directories">`providers.file.directories`</a> | Defines the list of paths to directories that contain the configuration files. The `filename`, `directory`, and `directories` options are mutually exclusive.  |  []    | Yes   |
| <a id="opt-providers-file-watch" href="#opt-providers-file-watch" title="#opt-providers-file-watch">`providers.file.watch`</a> | Set the `watch` option to `true` to allow Traefik to automatically watch for file changes. It works with the `filename`, `directory`, and `directories` options. | true | No |
